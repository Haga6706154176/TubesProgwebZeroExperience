...
<form class="form-horizontal" action="" method="post">
    <div class="form-group">
        ...
        <div class="col-lg-5">
            ...
            <input type="text" name="user" value="<?php echo $akun['user'];?>" readonly="readonly" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <input type="password" name="password" value="<?php echo $akun['password'];?>" class="form-control">
        </div>
    </div>
