        ...
        <body>
            ...
            <div class="navbar navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo site_url('web');?>">E-Asset</a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="<?php echo site_url('web');?>"><i class="glyphicon glyphicon-home"></i> Halaman Utama</a></li>
                        <li><a href="<?php echo site_url('web/anggota');?>"><i class="glyphicon glyphicon-user"></i> Daftar Anggota</a></li>
                    </ul>
                    <div class="nav navbar-nav navbar-right">
                        <form class="navbar-form navbar-left" role="search" action="<?php echo site_url('web/cari_buku');?>" method="post">
                            <div class="form-group">
                                <input type="text" name="cari" class="form-control" placeholder="Cari Asset">
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 ">
                        <legend>Selamat Datang di Aplikasi Pemanfaatan Asset</legend>
                    </div>
                </div>
            </div>
