            ...
            <div class="navbar navbar-default">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="<?php echo site_url('web');?>"><i class="glyphicon glyphicon-home"></i> Halaman Utama</a></li>
                        <li class="active"><a href="<?php echo site_url('web/anggota');?>"><i class="glyphicon glyphicon-user"></i> Daftar Anggota</a></li>
                    </ul>
