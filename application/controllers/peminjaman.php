...
class Peminjaman extends CI_Controller{
    ...
    function pencarianasset(){
        $cari=$this->input->post('cariasset');
        $data['asset']=$this->m_peminjaman->pencarianasset($cari)->result();
        $this->load->view('peminjaman/pencarianasset',$data);
    }
}