...
class Dashboard2 extends CI_Controller{
    ...
    function index(){
        ...
        $this->template2->display('dashboard/index2',$data);
    }
    ...
    function akun(){
        ...
        if($this->uri->segment(3)=="delete_success")
            ...
            $data['message']='';
        $this->template2->display('dashboard/akun',$data);
    }
    ...
    function tambahakun(){
        ...
        if($this->form_validation->run()==true){
            ...
            if($cek->num_rows()>0){
                ...
                $this->template2->display('dashboard/tambahakun',$data);
            }else{
                $info=array(
                    'user'=>$this->input->post('user'),
    ...
    function edit($id){
        ...
        if($this->form_validation->run()==true){
            ...
            $this->template2->display('dashboard/editpetugas',$data);
        }else{
            $data['message']="";
            $data['akun']=$this->m_akun->cekId($id)->row_array();
            $this->template2->display('dashboard/editpetugas',$data);
